...
# who didn't. You have decided to let people use the software for a free trial period and then require an activation key
# to continue using the product. Before you can cash out, the last step is to design a program that creates unique
...
def flip(command: list, activation_key: str):
...
def slice(command: list, activation_key: str):
